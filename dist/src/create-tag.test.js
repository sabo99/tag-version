...
describe('createTag', () => {
    ...
    beforeEach(() => {
        ...
        mockExit = jest.spyOn(process, 'exit').mockImplementation((code) => { throw new Error(`process.exit: ${code}`); });
    ...
    it('should create and push the Git tag when version exists in package.json', () => {
        // Mock dependencies
        path.resolve.mockReturnValue('/mock/package.json');
        readFileSync.mockReturnValue(mockPackageJson);
        createTag();
